...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        new Thread(() -> {
            MaxTextABC<String, Integer> abc = new MaxTextABC<>();
            try {
                abc = getMax(maxA, 'a');
            } catch (InterruptedException e) {
                throw new RuntimeException(e);
            }
            System.out.println("Текст с максимальным количеством букв b (" + abc.getCount() + "):\n" + abc.getText() + "\n");
        }).start();
        ...
        new Thread(() -> {
            ...
            System.out.println("Тест с максимальнфм колличеством букв с (" + abc.getCount() + "):\n" + abc.getText() + "\n");
        }).start();
        new Thread(() -> {
            MaxTextABC<String, Integer> abc = new MaxTextABC<>();
            try {
            ...
            System.out.println("Тест с максимальнфм колличеством букв b (" + abc.getCount() + "):\n" + abc.getText() + "\n");
        }).start();
    }
